...
require_once __DIR__ . "/performance.php"; // Include performance optimization functions
...
if (is_logged_in()) {
   ...
   // Set cache headers for non-logged in users
   set_cache_headers(3600); // Cache for 1 hour
}
?>
<!DOCTYPE html>
<html lang="en">
